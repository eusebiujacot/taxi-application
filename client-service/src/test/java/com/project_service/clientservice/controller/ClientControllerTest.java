...
class ClientControllerTest {
    ...
    void testClientFindById() throws Exception {
        String clientId = "c205da57-0722-4b5d-9c13-30adfe3b0d72";
        ...
        String responseJson = mockMvc.
                ...
                .getResponse()
                .getContentAsString();
        ClientApp clientApp = objectMapper.readValue(responseJson, ClientApp.class);

        assertEquals(clientId, clientApp.getId().toString());
    }
}
